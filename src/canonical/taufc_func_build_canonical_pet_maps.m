function canonical = taufc_func_build_canonical_pet_maps(pet_matrix, varargin)
% build canonical PET maps using Gaussian mixture modelling.
%
...
%--------------------------------------------------------------------------
error('taufc:notimplemented', ['taufc_func_build_canonical_pet_maps has not yet been filled with the exact ', ...
