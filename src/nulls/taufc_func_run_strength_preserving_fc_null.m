function null_fc = taufc_func_run_strength_preserving_fc_null(subject_fc, varargin)
% generate degree- and strength-preserving FC null matrices.
%
...
%--------------------------------------------------------------------------
error('taufc:notimplemented', ['taufc_func_run_strength_preserving_fc_null has not yet been filled with the exact ', ...
